---
title: "HS251113 Introduction to Python for Health Sciences"
semester: 'HS25'
format:
  html:
...
include-in-header:
  - text: |
      <style>
      .quarto-title-meta-contents, .quarto-title-meta-heading {
        display: none;
      }
      </style>
---
...
Vorlesungsverzeichnis: [https://portal.unilu.ch/details?code=HS251113](https://portal.unilu.ch/details?code=HS251113) <br>
Moodle: [https://elearning.hsm-unilu.ch/course/view.php?id=936](https://elearning.hsm-unilu.ch/course/view.php?id=936)

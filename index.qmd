...
listing:
  id: latest-news
  contents: news/*/*.qmd       # Directory where news items are located
  sort: "date desc"    # Show newest items first
  type: default        # Choose: default, grid, or table
  max-items: 5         # Limits the display to only the 5 most recent items
  sort-ui: false
  filter-ui: false
